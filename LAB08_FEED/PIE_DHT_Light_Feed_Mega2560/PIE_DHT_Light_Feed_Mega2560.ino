...
#define FEEDID  "FEEDID"                                  // ใส่ชื่อของ FEED หรือเรียกอีกชื่อคือ FEEDID
#define FEEDAPI  ""                                // ใส่ Default API Key ของ FEED
unsigned long lastTimeWriteFeed = 0;      // เก็บเวลา timestamp ล่าสุดที่เขียน Feed
